...
plt.rcParams['figure.figsize'] = [6, 6] # Все новые графики будут 8x5 дюймов
...
plt.plot(ty, C1, label="T = 1 мс", color="blue")
plt.plot(ty, C2, label="T = 5 мс", color="orange")
plt.plot(ty, C3, label="T = 10 мс", color ="green")
plt.plot(ty, C4, label="T = 120 мс", color="red")

plt.scatter(ty_p/2, C_p, color = "black")
plt.plot(ty_p/2, C_p, color = "black", label ="эксперимент")
